...
namespace Zephyr
{
    class ChasingSprite4 : Sprite
    {
        TrackManager4 trackManager4;

        public ChasingSprite4(Texture2D textureImage, Vector2 position,
...
TrackManager4 trackManager4)
        ...
        {
            this.trackManager4 = trackManager4;
        }
      ...
      TrackManager4 trackManager4)
        ...
        public override void Update(GameTime gameTime, Rectangle clientBounds)
        {
            ...
            Vector2 player = trackManager4.GetPlayerPosition();
