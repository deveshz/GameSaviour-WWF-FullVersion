...
namespace Zephyr
{
    ...
    /// </summary>
    public class SpriteManager5 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public SpriteManager5(Game game)
            : base(game)
        {
...
0), new Point(1, 1)));
            //--------------------GOAL BRICK---------------------------------
            goal1 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg4"),
...
0), new Point(1, 1));
            //--------------------DESTINATION BRICK---------------------------------------
            dest1 = new GoalBrick(
         Game.Content.Load<Texture2D>(@"Images/sorrowbox"),
         new Vector2(400,350), 50, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            dest2 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/sorrowbox"),
 ...
 0), new Point(1, 1));
            dest3 = new GoalBrick(
                Game.Content.Load<Texture2D>(@"Images/sorrowbox"),
                new Vector2(500,350), 50, new Point(50, 50), new
  Point(0, 0), new Point(1, 1));
            dest4 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/sorrowbox"),
...
0), new Point(1, 1));
            //--------------------------------------------------
            final1 = Game.Content.Load<Texture2D>(@"Images/mdg4");
            final2 = Game.Content.Load<Texture2D>(@"Images/mdg4");
            final3 = Game.Content.Load<Texture2D>(@"Images/mdg4");
            final4 = Game.Content.Load<Texture2D>(@"Images/mdg4");
            final5 = Game.Content.Load<Texture2D>(@"Images/mdg4");
            final6 = Game.Content.Load<Texture2D>(@"Images/mdg4");
            ...
            background = Game.Content.Load<Texture2D>(@"Images\bg6");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (((Game1)Game).chances3 > 0)
                loose = false;
            else if (((Game1)Game).chances3 <= 0 && steps == -1)
                loose = true;
