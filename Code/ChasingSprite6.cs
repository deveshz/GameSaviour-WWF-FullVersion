...
namespace Zephyr
{
    class ChasingSprite6 : Sprite
    {
        TrackManager6 trackManager6;

        public ChasingSprite6(Texture2D textureImage, Vector2 position,
...
TrackManager6 trackManager6)
        ...
        {
            this.trackManager6 = trackManager6;
        }
      ...
      TrackManager6 trackManager6)
        ...
        public override void Update(GameTime gameTime, Rectangle clientBounds)
        {
            ...
            Vector2 player = trackManager6.GetPlayerPosition();
