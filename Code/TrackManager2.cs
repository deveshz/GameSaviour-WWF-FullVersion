...
namespace Zephyr
{
    ...
    /// </summary>
    public class TrackManager2 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        Vector2 carPosition = new Vector2(80, 150);
        ...
        bool moveup = false;
        bool movedown = false;
        public TrackManager2(Game game)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            track = Game.Content.Load<Texture2D>(@"Images/H");
       ...
       carHeight + 100, true, SurfaceFormat.Color,DepthFormat.Depth24Stencil8);
            ...
            mdg1 = Game.Content.Load<Texture2D>(@"Images/mdg2");
            mdg11 = Game.Content.Load<Texture2D>(@"Images/mdg2");

            mdg12 = Game.Content.Load<Texture2D>(@"Images/mdg2");

            mdg13 = Game.Content.Load<Texture2D>(@"Images/mdg2");

            mdg14 = Game.Content.Load<Texture2D>(@"Images/mdg2");
            mdg15 = Game.Content.Load<Texture2D>(@"Images/mdg2");
            ...
            mdg1rep = Game.Content.Load<Texture2D>(@"Images/mdg2rep");
            obstacle = Game.Content.Load<Texture2D>(@"Images/obstacle");
            obstaclerep = Game.Content.Load<Texture2D>(@"Images/obstaclerep");
            trackoverlay = Game.Content.Load<Texture2D>(@"Images/overlayH");
            text = Game.Content.Load<SpriteFont>(@"Fonts\Snap");
            report = Game.Content.Load<Texture2D>(@"Images/reportc");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (power6)
                ...
                mdg8Rect = new Rectangle(50,480, 50, 50);
            if (power7)
                mdg81Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg81Rect = new Rectangle(380, 300, 50, 50);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.Draw(mdg8, new Vector2(50, 480), Color.White);
                b = true;
            }
            else
                power6 = false;
            ...
            {
                spriteBatch.Draw(mdg81, new Vector2(380, 300), Color.White);
                c = true;
            }
            else
                power7 = false;
            ...
            if (power)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(50, 430, 50, 50), Color.White);
            ...
            if (power6)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(50, 480, 50, 50), Color.White);


            }
            if (power7)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(380, 300, 50, 50), Color.White);
...
1, SpriteEffects.None, 1);
        ...
        private void SpawnEnemy()
        {
            ...
            // Create the sprite
          spriteList.Add(
               new ChasingSprite2(Game.Content.Load<Texture2D>(@"Images\ignorance"),
               position + new Vector2(-120, 80), new Point(60, 60), 10, new Point(0, 0),
               new Point(1, 1), speed, this));
            spriteList2.Add(
           new ChasingSprite2(Game.Content.Load<Texture2D>(@"Images\superstition"),
