...
namespace Zephyr
{
    ...
    /// </summary>
    public class TrackManager10 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        Vector2 carPosition = new Vector2(480,100);
        ...
        bool moveup = false;
        bool movedown = false;
        public TrackManager10(Game game)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            track = Game.Content.Load<Texture2D>(@"Images/F");
       ...
       carHeight + 100, true, SurfaceFormat.Color, DepthFormat.Depth24Stencil8);
            ...
            mdg1 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            mdg11 = Game.Content.Load<Texture2D>(@"Images/mdg7");

            mdg12 = Game.Content.Load<Texture2D>(@"Images/mdg7");

            mdg13 = Game.Content.Load<Texture2D>(@"Images/mdg7");

            mdg14 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            mdg15 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            ...
            mdg1rep = Game.Content.Load<Texture2D>(@"Images/mdg7rep1");
            obstacle = Game.Content.Load<Texture2D>(@"Images/obstacle");
            obstaclerep = Game.Content.Load<Texture2D>(@"Images/obstaclerep");
            trackoverlay = Game.Content.Load<Texture2D>(@"Images/overlayF");
            text = Game.Content.Load<SpriteFont>(@"Fonts\Snap");
            report = Game.Content.Load<Texture2D>(@"Images/reportk");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.Draw(mdg8, new Vector2(229,67), Color.White);
                b = true;
            }
            else
                power6 = false;
            ...
            {
                spriteBatch.Draw(mdg81, new Vector2(309,164), Color.White);
                c = true;
            }
            else
                power7 = false;
            ...
            if (power)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(244,176, 50, 50), Color.White);
            ...
            if (power1)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(270,500, 50, 50), Color.White);
            ...
            if (power3)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(232,395, 50, 50), Color.White);

            }
            if (power4)
            {

                spriteBatch.Draw(mdg1rep, new Rectangle(387,287, 50, 50), Color.White);
            ...
            if (power6)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(229,67, 50, 50), Color.White);


            }
            if (power7)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(309,164, 50, 50), Color.White);
...
1, SpriteEffects.None, 1);
        ...
        private void SpawnEnemy()
        {
            ...
            // Create the sprite
            spriteList.Add(
                 new ChasingSprite10(Game.Content.Load<Texture2D>(@"Images\pollution"),
                 position + new Vector2(-120, 80), new Point(60, 60), 10, new Point(0, 0),
                 new Point(1, 1), speed, this));
            spriteList2.Add(
           new ChasingSprite10(Game.Content.Load<Texture2D>(@"Images\globalwarming"),
