...
namespace Zephyr
{
    ...
    /// </summary>
    public class TrackManager8 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        Vector2 carPosition = new Vector2(75,92);
        ...
        bool moveup = false;
        bool movedown = false;
        public TrackManager8(Game game)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            track = Game.Content.Load<Texture2D>(@"Images/G");
       ...
       carHeight + 100, true, SurfaceFormat.Color, DepthFormat.Depth24Stencil8);
            ...
            mdg1 = Game.Content.Load<Texture2D>(@"Images/mdg6");
            mdg11 = Game.Content.Load<Texture2D>(@"Images/mdg6");

            mdg12 = Game.Content.Load<Texture2D>(@"Images/mdg6");

            mdg13 = Game.Content.Load<Texture2D>(@"Images/mdg6");

            mdg14 = Game.Content.Load<Texture2D>(@"Images/mdg6");
            mdg15 = Game.Content.Load<Texture2D>(@"Images/mdg6");
            ...
            mdg1rep = Game.Content.Load<Texture2D>(@"Images/mdg6rep");
            obstacle = Game.Content.Load<Texture2D>(@"Images/obstacle");
            obstaclerep = Game.Content.Load<Texture2D>(@"Images/obstaclerep");
            trackoverlay = Game.Content.Load<Texture2D>(@"Images/overlayG");
            text = Game.Content.Load<SpriteFont>(@"Fonts\Snap");
            report = Game.Content.Load<Texture2D>(@"Images/reporti");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.Draw(mdg8, new Vector2(343,70), Color.White);
                b = true;
            }
            else
                power6 = false;
            ...
            {
                spriteBatch.Draw(mdg81, new Vector2(390,250), Color.White);
                c = true;
            }
            else
                power7 = false;
            ...
            if (power)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(127,274, 50, 50), Color.White);
            ...
            if (power1)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(69,418, 50, 50), Color.White);
            ...
            if (power3)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(290,457, 50, 50), Color.White);

            }
            if (power4)
            {

                spriteBatch.Draw(mdg1rep, new Rectangle(330,152,50, 50), Color.White);
            ...
            if (power6)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(343,70, 50, 50), Color.White);


            }
            if (power7)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(390,250, 50, 50), Color.White);
...
1, SpriteEffects.None, 1);
        ...
        private void SpawnEnemy()
        {
            ...
            // Create the sprite
            spriteList.Add(
                 new ChasingSprite8(Game.Content.Load<Texture2D>(@"Images\death"),
                 position + new Vector2(-120, 80), new Point(60, 60), 10, new Point(0, 0),
                 new Point(1, 1), speed, this));
            spriteList2.Add(
           new ChasingSprite8(Game.Content.Load<Texture2D>(@"Images\epidemic"),
