...
namespace Zephyr
{
    ...
    /// </summary>
    public class TrackManager9 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        Vector2 carPosition = new Vector2(159,203);
        ...
        bool moveup = false;
        bool movedown = false;
        public TrackManager9(Game game)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            track = Game.Content.Load<Texture2D>(@"Images/N");
       ...
       carHeight + 100, true, SurfaceFormat.Color, DepthFormat.Depth24Stencil8);
            ...
            mdg1rep = Game.Content.Load<Texture2D>(@"Images/mdg7rep");
            obstacle = Game.Content.Load<Texture2D>(@"Images/obstacle");
            obstaclerep = Game.Content.Load<Texture2D>(@"Images/obstaclerep");
            trackoverlay = Game.Content.Load<Texture2D>(@"Images/overlayN");
            text = Game.Content.Load<SpriteFont>(@"Fonts\Snap");
            report = Game.Content.Load<Texture2D>(@"Images/reportj");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.Draw(mdg8, new Vector2(180,407), Color.White);
                b = true;
            }
            else
                power6 = false;
            ...
            {
                spriteBatch.Draw(mdg81, new Vector2(381,149), Color.White);
                c = true;
            }
            else
                power7 = false;
            ...
            if (power)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(318,181, 50, 50), Color.White);
            ...
            if (power1)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(519,284, 50, 50), Color.White);
            ...
            if (power3)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(559,478, 50, 50), Color.White);

            }
            if (power4)
            {

                spriteBatch.Draw(mdg1rep, new Rectangle(175,493, 50, 50), Color.White);
            ...
            if (power6)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(180,407, 50, 50), Color.White);


            }
            if (power7)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(381,149, 50, 50), Color.White);
...
1, SpriteEffects.None, 1);
        ...
        private void SpawnEnemy()
        {
            ...
            // Create the sprite
            spriteList.Add(
                 new ChasingSprite9(Game.Content.Load<Texture2D>(@"Images\pollution"),
                 position + new Vector2(-120, 80), new Point(60, 60), 10, new Point(0, 0),
                 new Point(1, 1), speed, this));
            spriteList2.Add(
           new ChasingSprite9(Game.Content.Load<Texture2D>(@"Images\globalwarming"),
