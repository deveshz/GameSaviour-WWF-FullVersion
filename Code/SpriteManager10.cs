...
namespace Zephyr
{
    ...
    /// </summary>
    public class SpriteManager10 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public SpriteManager10(Game game)
            : base(game)
        {
...
Vector2(600,450), 0, new Point(50, 50), new Point(0, 0), new Point(4, 4), 0);
            //-----------------------ROW  1 -----------------------------------------------
...
0), new Point(1, 1)));
 ...
 0), new Point(1, 1)));
            ...
            //-----------------------------------------------------
            goal1 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg7"),
             new Vector2(550,200), 0, new Point(50, 50), new
...
0), new Point(1, 1));
            goal6 = new GoalBrick(
        Game.Content.Load<Texture2D>(@"Images/mdg7"),
        new Vector2(500, 400), 0, new Point(50, 50), new Point(0,
0), new Point(1, 1));
            goal7 = new GoalBrick(
  Game.Content.Load<Texture2D>(@"Images/mdg7"),
...
0), new Point(1, 1));
            //-----------------------------------------------------------
            dest1 = new GoalBrick(
         Game.Content.Load<Texture2D>(@"Images/globalwarming"),
         new Vector2(450, 200), 50, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            dest2 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/globalwarming"),
 ...
 0), new Point(1, 1));
            dest3 = new GoalBrick(
                Game.Content.Load<Texture2D>(@"Images/globalwarming"),
                new Vector2(600, 200), 50, new Point(50, 50), new
  Point(0, 0), new Point(1, 1));
            dest4 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/globalwarming"),
            new Vector2(650, 200), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest5 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/globalwarming"),
           new Vector2(450, 250), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest6 = new GoalBrick(
          Game.Content.Load<Texture2D>(@"Images/globalwarming"),
          new Vector2(500, 250), 50, new Point(50, 50), new Point(0,
0), new Point(1, 1));
            dest7 = new GoalBrick(
          Game.Content.Load<Texture2D>(@"Images/globalwarming"),
          new Vector2(600,250), 50, new Point(50, 50), new Point(0,
0), new Point(1, 1));
            dest8 = new GoalBrick(
          Game.Content.Load<Texture2D>(@"Images/globalwarming"),
          new Vector2(650,250), 50, new Point(50, 50), new Point(0,
0), new Point(1, 1));
            //--------------------------------------------------
            final1 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            final2 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            final3 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            final4 = Game.Content.Load<Texture2D>(@"Images/mdg7");

            final5 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            final6 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            final7 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            final8 = Game.Content.Load<Texture2D>(@"Images/mdg7");
            ...
            background = Game.Content.Load<Texture2D>(@"Images\bg12");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (((Game1)Game).chances6 > 0)
                loose = false;
            else if (((Game1)Game).chances6 <= 0 && steps == -1)
                loose = true;
            ...
            dest7.Update(gameTime, Game.Window.ClientBounds);
            dest8.Update(gameTime, Game.Window.ClientBounds);
            ...
            goal7.Update(gameTime, Game.Window.ClientBounds);
            goal8.Update(gameTime, Game.Window.ClientBounds);
            if (goal1.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                else if ((goal1.position.Y == goal7.position.Y) && ((goal7.position.X == goal1.position.X - 50)))
                {
                    goal1.position.X = goal1.position.X;
                    saviour.position.X = goal1.position.X + 50;
                }
                else if ((goal1.position.Y == goal8.position.Y) && ((goal8.position.X == goal1.position.X - 50)))
                {
                    goal1.position.X = goal1.position.X;
                    saviour.position.X = goal1.position.X + 50;
                }
            ...
            if (goal1.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                else if ((goal1.position.X == goal7.position.X) && ((goal1.position.Y == goal7.position.Y - 50)))
                {
                    goal1.position.Y = goal1.position.Y;
                    saviour.position.Y = goal1.position.Y - 50;
                }
                else if ((goal1.position.X == goal8.position.X) && ((goal1.position.Y == goal8.position.Y - 50)))
                {
                    goal1.position.Y = goal1.position.Y;
                    saviour.position.Y = goal1.position.Y - 50;
                }
            ...
            if (goal1.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 3) && (keyboardState.IsKeyDown(Keys.Right)))
            {
                ...
                else if ((goal1.position.Y == goal7.position.Y) && ((goal1.position.X == goal7.position.X - 50)))
                {
                    goal1.position.X = goal1.position.X;
                    saviour.position.X = goal1.position.X - 50;
                }
                else if ((goal1.position.Y == goal8.position.Y) && ((goal1.position.X == goal8.position.X - 50)))
                {
                    goal1.position.X = goal1.position.X;
                    saviour.position.X = goal1.position.X - 50;
                }
            ...
            if (goal5.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                else if ((goal7.position.Y == goal5.position.Y) && ((goal7.position.X == goal5.position.X - 50)))
                {
                    goal5.position.X = goal5.position.X;
                    saviour.position.X = goal5.position.X + 50;
                }
                else if ((goal8.position.Y == goal5.position.Y) && ((goal8.position.X == goal5.position.X - 50)))
                {
                    goal5.position.X = goal5.position.X;
                    saviour.position.X = goal5.position.X + 50;
                }
            ...
            if (goal5.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                else if ((goal7.position.X == goal5.position.X) && ((goal5.position.Y == goal7.position.Y - 50)))
                {
                    goal5.position.Y = goal5.position.Y;
                    saviour.position.Y = goal5.position.Y - 50;
                }
                else if ((goal8.position.X == goal5.position.X) && ((goal5.position.Y == goal8.position.Y - 50)))
                {
                    goal5.position.Y = goal5.position.Y;
                    saviour.position.Y = goal5.position.Y - 50;
                }
            ...
            if (goal2.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                else if ((goal2.position.Y == goal7.position.Y) && ((goal7.position.X == goal2.position.X - 50)))
                {
                    goal2.position.X = goal2.position.X;
                    saviour.position.X = goal2.position.X + 50;
                }
                else if ((goal2.position.Y == goal8.position.Y) && ((goal8.position.X == goal2.position.X - 50)))
                {
                    goal2.position.X = goal2.position.X;
                    saviour.position.X = goal2.position.X + 50;
                }
            ...
            if (goal2.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                else if ((goal2.position.X == goal7.position.X) && ((goal2.position.Y == goal7.position.Y - 50)))
                {
                    goal2.position.Y = goal2.position.Y;
                    saviour.position.Y = goal2.position.Y - 50;
                }
                else if ((goal2.position.X == goal8.position.X) && ((goal2.position.Y == goal8.position.Y - 50)))
                {
                    goal2.position.Y = goal2.position.Y;
                    saviour.position.Y = goal2.position.Y - 50;
                }
            ...
            if (goal2.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 3) && (keyboardState.IsKeyDown(Keys.Right)))
            {
                ...
                else if ((goal2.position.Y == goal7.position.Y) && ((goal2.position.X == goal7.position.X - 50)))
                {
                    goal2.position.X = goal2.position.X;
                    saviour.position.X = goal2.position.X - 50;
                }
                else if ((goal2.position.Y == goal8.position.Y) && ((goal2.position.X == goal8.position.X - 50)))
                {
                    goal2.position.X = goal2.position.X;
                    saviour.position.X = goal2.position.X - 50;
                }
            ...
            if (goal3.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                else if ((goal3.position.Y == goal7.position.Y) && ((goal7.position.X == goal3.position.X - 50)))
                {
                    goal3.position.X = goal3.position.X;
                    saviour.position.X = goal3.position.X + 50;
                }
                else if ((goal3.position.Y == goal8.position.Y) && ((goal8.position.X == goal3.position.X - 50)))
                {
                    goal3.position.X = goal3.position.X;
                    saviour.position.X = goal3.position.X + 50;
                }
            ...
            if (goal3.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                else if ((goal3.position.X == goal7.position.X) && ((goal3.position.Y == goal7.position.Y - 50)))
                {
                    goal3.position.Y = goal3.position.Y;
                    saviour.position.Y = goal3.position.Y - 50;
                }
                else if ((goal3.position.X == goal8.position.X) && ((goal3.position.Y == goal8.position.Y - 50)))
                {
                    goal3.position.Y = goal3.position.Y;
                    saviour.position.Y = goal3.position.Y - 50;
                }
            ...
            if (goal3.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 3) && (keyboardState.IsKeyDown(Keys.Right)))
            {
                ...
                else if ((goal3.position.Y == goal7.position.Y) && ((goal3.position.X == goal7.position.X - 50)))
                {
                    goal3.position.X = goal3.position.X;
                    saviour.position.X = goal3.position.X - 50;
                }
                else if ((goal3.position.Y == goal8.position.Y) && ((goal3.position.X == goal8.position.X - 50)))
                {
                    goal3.position.X = goal3.position.X;
                    saviour.position.X = goal3.position.X - 50;
                }
            ...
            if (goal4.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                else if ((goal4.position.Y == goal7.position.Y) && ((goal7.position.X == goal4.position.X - 50)))
                {
                    goal4.position.X = goal4.position.X;
                    saviour.position.X = goal4.position.X + 50;
                }
                else if ((goal4.position.Y == goal8.position.Y) && ((goal8.position.X == goal4.position.X - 50)))
                {
                    goal4.position.X = goal4.position.X;
                    saviour.position.X = goal4.position.X + 50;
                }
            ...
            if (goal4.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                else if ((goal4.position.X == goal7.position.X) && ((goal4.position.Y == goal7.position.Y - 50)))
                {
                    goal4.position.Y = goal4.position.Y;
                    saviour.position.Y = goal4.position.Y - 50;
                }
                else if ((goal4.position.X == goal8.position.X) && ((goal4.position.Y == goal8.position.Y - 50)))
                {
                    goal4.position.Y = goal4.position.Y;
                    saviour.position.Y = goal4.position.Y - 50;
                }
            ...
            if (goal4.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 3) && (keyboardState.IsKeyDown(Keys.Right)))
            {
                ...
                else if ((goal4.position.Y == goal7.position.Y) && ((goal4.position.X == goal7.position.X - 50)))
                {
                    goal4.position.X = goal4.position.X;
                    saviour.position.X = goal4.position.X - 50;
                }
                else if ((goal4.position.Y == goal8.position.Y) && ((goal4.position.X == goal8.position.X - 50)))
                {
                    goal4.position.X = goal4.position.X;
                    saviour.position.X = goal4.position.X - 50;
                }
            ...
            if (goal6.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 3) && (keyboardState.IsKeyDown(Keys.Right)))
            {
                ...
                else if ((goal6.position.Y == goal7.position.Y) && ((goal6.position.X == goal7.position.X - 50)))
                {
                    goal6.position.X = goal6.position.X;
                    saviour.position.X = goal6.position.X - 50;
                }
                else if ((goal6.position.Y == goal8.position.Y) && ((goal6.position.X == goal8.position.X - 50)))
                {
                    goal6.position.X = goal6.position.X;
                    saviour.position.X = goal6.position.X - 50;
                }
            ...
            if (goal6.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                ...
                else if ((goal6.position.Y == goal7.position.Y) && ((goal7.position.X == goal6.position.X - 50)))
                {
                    goal6.position.X = goal6.position.X;
                    saviour.position.X = goal6.position.X + 50;
                }
                else if ((goal6.position.Y == goal8.position.Y) && ((goal8.position.X == goal6.position.X - 50)))
                {
                    goal6.position.X = goal6.position.X;
                    saviour.position.X = goal6.position.X + 50;
                }
            ...
            if (goal6.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                else if ((goal6.position.X == goal7.position.X) && ((goal6.position.Y == goal7.position.Y - 50)))
                {
                    goal6.position.Y = goal6.position.Y;
                    saviour.position.Y = goal6.position.Y - 50;
                }
                else if ((goal6.position.X == goal8.position.X) && ((goal6.position.Y == goal8.position.Y - 50)))
                {
                    goal6.position.Y = goal6.position.Y;
                    saviour.position.Y = goal6.position.Y - 50;
                }
            ...
            if (goal7.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 3) && (keyboardState.IsKeyDown(Keys.Right)))
            {
                if ((goal7.position.Y == goal5.position.Y) && ((goal7.position.X == goal5.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X - 50;
                }
                else if ((goal7.position.Y == goal1.position.Y) && ((goal7.position.X == goal1.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X - 50;
                }
                else if ((goal7.position.Y == goal2.position.Y) && ((goal7.position.X == goal2.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X - 50;
                }
                else if ((goal7.position.Y == goal3.position.Y) && ((goal7.position.X == goal3.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X - 50;
                }
                else if ((goal7.position.Y == goal4.position.Y) && ((goal7.position.X == goal4.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X - 50;
                }
                else if ((goal7.position.Y == goal6.position.Y) && ((goal7.position.X == goal6.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X - 50;
                }
                else if ((goal7.position.Y == goal8.position.Y) && ((goal7.position.X == goal8.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X - 50;
                }
                ...
                {
                    goal7.position.X = goal7.position.X + 50;
                    saviour.position.X = saviour.position.X;
                }

                if (saviour.position.X >= 700)
                    saviour.position.X = 700;
                if (goal7.position.X >= 750)
                    goal7.position.X = 750;

            }
            if (goal7.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                if ((goal7.position.Y == goal5.position.Y) && ((goal5.position.X == goal7.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X + 50;
                }
                else if ((goal7.position.Y == goal1.position.Y) && ((goal1.position.X == goal7.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X + 50;
                }
                else if ((goal7.position.Y == goal2.position.Y) && ((goal2.position.X == goal7.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X + 50;
                }
                else if ((goal7.position.Y == goal3.position.Y) && ((goal3.position.X == goal7.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X + 50;
                }
                else if ((goal7.position.Y == goal4.position.Y) && ((goal4.position.X == goal7.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X + 50;
                }
                ...
                else if ((goal7.position.Y == goal8.position.Y) && ((goal8.position.X == goal7.position.X - 50)))
                {
                    goal7.position.X = goal7.position.X;
                    saviour.position.X = goal7.position.X + 50;
                }
                ...
                if (saviour.position.X <= 400)
                    saviour.position.X = 400;
                if (goal7.position.X <= 350)
                    goal7.position.X = 350;

            }
            if (goal7.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                if ((goal7.position.X == goal5.position.X) && ((goal7.position.Y == goal5.position.Y - 50)))
                {
                    goal7.position.Y = goal7.position.Y;
                    saviour.position.Y = goal7.position.Y - 50;
                }
                else if ((goal7.position.X == goal1.position.X) && ((goal7.position.Y == goal1.position.Y - 50)))
                {
                    goal7.position.Y = goal7.position.Y;
                    saviour.position.Y = goal7.position.Y - 50;
                }
                else if ((goal7.position.X == goal2.position.X) && ((goal7.position.Y == goal2.position.Y - 50)))
                {
                    goal7.position.Y = goal7.position.Y;
                    saviour.position.Y = goal7.position.Y - 50;
                }
                else if ((goal7.position.X == goal3.position.X) && ((goal7.position.Y == goal3.position.Y - 50)))
                {
                    goal7.position.Y = goal7.position.Y;
                    saviour.position.Y = goal7.position.Y - 50;
                }
                else if ((goal7.position.X == goal4.position.X) && ((goal7.position.Y == goal4.position.Y - 50)))
                {
                    goal7.position.Y = goal7.position.Y;
                    saviour.position.Y = goal7.position.Y - 50;
                }
                else if ((goal7.position.X == goal6.position.X) && ((goal7.position.Y == goal6.position.Y - 50)))
                {
                    goal7.position.Y = goal7.position.Y;
                    saviour.position.Y = goal7.position.Y - 50;
                }
                else if ((goal7.position.X == goal8.position.X) && ((goal7.position.Y == goal8.position.Y - 50)))
                {
                    goal7.position.Y = goal7.position.Y;
                    saviour.position.Y = goal7.position.Y - 50;
                }
                ...
                {
                    goal7.position.Y = goal7.position.Y + 50;
                    saviour.position.Y = saviour.position.Y;
                }
                ...
                if (saviour.position.Y >= 450)
                    saviour.position.Y = 450;
                if (goal7.position.Y >= 500)
                    goal7.position.Y = 500;

            }
            if (goal7.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 1) && (keyboardState.IsKeyDown(Keys.Up)))
            {
                if ((goal7.position.X == goal5.position.X) && ((goal7.position.Y == goal5.position.Y + 50)))
                {
                    goal7.position.Y = goal7.position.Y;
                ...
                if (saviour.position.Y <= 200)
                    saviour.position.Y = 200;
                if (goal7.position.Y <= 150)
                    goal7.position.Y = 150;

            }
            if (goal8.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 3) && (keyboardState.IsKeyDown(Keys.Right)))
            {
                if ((goal8.position.Y == goal5.position.Y) && ((goal8.position.X == goal5.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X - 50;
                }
                else if ((goal8.position.Y == goal1.position.Y) && ((goal8.position.X == goal1.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X - 50;
                }
                else if ((goal8.position.Y == goal2.position.Y) && ((goal8.position.X == goal2.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X - 50;
                }
                else if ((goal8.position.Y == goal3.position.Y) && ((goal8.position.X == goal3.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X - 50;
                }
                else if ((goal8.position.Y == goal4.position.Y) && ((goal8.position.X == goal4.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X - 50;
                }
                else if ((goal8.position.Y == goal6.position.Y) && ((goal8.position.X == goal6.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X - 50;
                }
                else if ((goal8.position.Y == goal7.position.Y) && ((goal8.position.X == goal7.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X - 50;
                }
                ...
                {
                    goal8.position.X = goal8.position.X + 50;
                    saviour.position.X = saviour.position.X;
                }

                if (saviour.position.X >= 700)
                    saviour.position.X = 700;
                if (goal8.position.X >= 750)
                    goal8.position.X = 750;

            }
            if (goal8.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 0) && (keyboardState.IsKeyDown(Keys.Left)))
            {
                if ((goal8.position.Y == goal5.position.Y) && ((goal5.position.X == goal8.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X + 50;
                }
                else if ((goal8.position.Y == goal1.position.Y) && ((goal1.position.X == goal8.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X + 50;
                }
                else if ((goal8.position.Y == goal2.position.Y) && ((goal2.position.X == goal8.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X + 50;
                }
                else if ((goal8.position.Y == goal3.position.Y) && ((goal3.position.X == goal8.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X + 50;
                }
                else if ((goal8.position.Y == goal4.position.Y) && ((goal4.position.X == goal8.position.X - 50)))
                {
                    goal8.position.X = goal8.position.X;
                    saviour.position.X = goal8.position.X + 50;
                }
                ...
                if (saviour.position.X <= 400)
                    saviour.position.X = 400;
                if (goal8.position.X <= 350)
                    goal8.position.X = 350;

            }
            if (goal8.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                if ((goal8.position.X == goal5.position.X) && ((goal8.position.Y == goal5.position.Y - 50)))
                {
                    goal8.position.Y = goal8.position.Y;
                    saviour.position.Y = goal8.position.Y - 50;
                }
                else if ((goal8.position.X == goal1.position.X) && ((goal8.position.Y == goal1.position.Y - 50)))
                {
                    goal8.position.Y = goal8.position.Y;
                    saviour.position.Y = goal8.position.Y - 50;
                }
                else if ((goal8.position.X == goal2.position.X) && ((goal8.position.Y == goal2.position.Y - 50)))
                {
                    goal8.position.Y = goal8.position.Y;
                    saviour.position.Y = goal8.position.Y - 50;
                }
                else if ((goal8.position.X == goal3.position.X) && ((goal8.position.Y == goal3.position.Y - 50)))
                {
                    goal8.position.Y = goal8.position.Y;
                    saviour.position.Y = goal8.position.Y - 50;
                }
                else if ((goal8.position.X == goal4.position.X) && ((goal8.position.Y == goal4.position.Y - 50)))
                {
                    goal8.position.Y = goal8.position.Y;
                    saviour.position.Y = goal8.position.Y - 50;
                }
                else if ((goal8.position.X == goal6.position.X) && ((goal8.position.Y == goal6.position.Y - 50)))
                {
                    goal8.position.Y = goal8.position.Y;
                    saviour.position.Y = goal8.position.Y - 50;
                }
                else if ((goal8.position.X == goal7.position.X) && ((goal8.position.Y == goal7.position.Y - 50)))
                {
                    goal8.position.Y = goal8.position.Y;
                    saviour.position.Y = goal8.position.Y - 50;
                }
                ...
                {
                    goal8.position.Y = goal8.position.Y + 50;
                    saviour.position.Y = saviour.position.Y;
                }
                ...
                if (saviour.position.Y >= 450)
                    saviour.position.Y = 450;
                if (goal8.position.Y >= 500)
                    goal8.position.Y = 500;

            }
            if (goal8.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 1) && (keyboardState.IsKeyDown(Keys.Up)))
            {
                if ((goal8.position.X == goal5.position.X) && ((goal8.position.Y == goal5.position.Y + 50)))
                {
                    goal8.position.Y = goal8.position.Y;
                ...
                if (saviour.position.Y <= 200)
                    saviour.position.Y = 200;
                if (goal8.position.Y <= 150)
                    goal8.position.Y = 150;
            ...
            foreach (Brick s in spriteList)
            {
                ...
                if (s.collisionRect.Intersects(goal7.collisionRect) && (keyboardState.IsKeyDown(Keys.Left)))
                {
                    goal7.position.X = s.position.X + 50;
                    saviour.position.X = goal7.position.X + 50;
                }
                if (s.collisionRect.Intersects(goal7.collisionRect) && (keyboardState.IsKeyDown(Keys.Right)))
                {
                    goal7.position.X = s.position.X - 50;
                    saviour.position.X = goal7.position.X - 50;
                }
                if (s.collisionRect.Intersects(goal7.collisionRect) && (keyboardState.IsKeyDown(Keys.Up)))
                {
                    goal7.position.Y = s.position.Y + 50;
                    saviour.position.Y = goal7.position.Y + 50;
                }
                if (s.collisionRect.Intersects(goal7.collisionRect) && (keyboardState.IsKeyDown(Keys.Down)))
                {
                    goal7.position.Y = s.position.Y - 50;
                    saviour.position.Y = goal7.position.Y - 50;
                }
            ...
            foreach (Brick s in spriteList)
            {
                ...
                if (s.collisionRect.Intersects(goal8.collisionRect) && (keyboardState.IsKeyDown(Keys.Left)))
                {
                    goal8.position.X = s.position.X + 50;
                    saviour.position.X = goal8.position.X + 50;
                }
                if (s.collisionRect.Intersects(goal8.collisionRect) && (keyboardState.IsKeyDown(Keys.Right)))
                {
                    goal8.position.X = s.position.X - 50;
                    saviour.position.X = goal8.position.X - 50;
                }
                if (s.collisionRect.Intersects(goal8.collisionRect) && (keyboardState.IsKeyDown(Keys.Up)))
                {
                    goal8.position.Y = s.position.Y + 50;
                    saviour.position.Y = goal8.position.Y + 50;
                }
                if (s.collisionRect.Intersects(goal8.collisionRect) && (keyboardState.IsKeyDown(Keys.Down)))
                {
                    goal8.position.Y = s.position.Y - 50;
                    saviour.position.Y = goal8.position.Y - 50;
                }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            dest7.Draw(gameTime, spriteBatch);
            dest8.Draw(gameTime, spriteBatch);
            ...
            goal7.Draw(gameTime, spriteBatch);
            goal8.Draw(gameTime, spriteBatch);
            if (goal1.collisionRect.Equals(dest1.collisionRect) || goal1.collisionRect.Equals(dest2.collisionRect) || goal1.collisionRect.Equals(dest3.collisionRect) || goal1.collisionRect.Equals(dest4.collisionRect) || goal1.collisionRect.Equals(dest5.collisionRect) || goal1.collisionRect.Equals(dest6.collisionRect) || goal1.collisionRect.Equals(dest7.collisionRect) || goal1.collisionRect.Equals(dest8.collisionRect))
            {
            ...
            if (goal2.collisionRect.Equals(dest1.collisionRect) || goal2.collisionRect.Equals(dest2.collisionRect) || goal2.collisionRect.Equals(dest3.collisionRect) || goal2.collisionRect.Equals(dest4.collisionRect) || goal2.collisionRect.Equals(dest5.collisionRect) || goal2.collisionRect.Equals(dest6.collisionRect) || goal2.collisionRect.Equals(dest7.collisionRect) || goal2.collisionRect.Equals(dest8.collisionRect))
            {
            ...
            if (goal3.collisionRect.Equals(dest1.collisionRect) || goal3.collisionRect.Equals(dest2.collisionRect) || goal3.collisionRect.Equals(dest3.collisionRect) || goal3.collisionRect.Equals(dest4.collisionRect) || goal3.collisionRect.Equals(dest5.collisionRect) || goal3.collisionRect.Equals(dest6.collisionRect) || goal3.collisionRect.Equals(dest7.collisionRect) || goal3.collisionRect.Equals(dest8.collisionRect))
            {
            ...
            if (goal4.collisionRect.Equals(dest1.collisionRect) || goal4.collisionRect.Equals(dest2.collisionRect) || goal4.collisionRect.Equals(dest3.collisionRect) || goal4.collisionRect.Equals(dest4.collisionRect) || goal4.collisionRect.Equals(dest5.collisionRect) || goal4.collisionRect.Equals(dest6.collisionRect) || goal4.collisionRect.Equals(dest7.collisionRect) || goal4.collisionRect.Equals(dest8.collisionRect))
            {
            ...
            if (goal5.collisionRect.Equals(dest1.collisionRect) || goal5.collisionRect.Equals(dest2.collisionRect) || goal5.collisionRect.Equals(dest3.collisionRect) || goal5.collisionRect.Equals(dest4.collisionRect) || goal5.collisionRect.Equals(dest5.collisionRect) || goal5.collisionRect.Equals(dest6.collisionRect) || goal5.collisionRect.Equals(dest7.collisionRect) || goal5.collisionRect.Equals(dest8.collisionRect))
            {
            ...
            if (goal6.collisionRect.Equals(dest1.collisionRect) || goal6.collisionRect.Equals(dest2.collisionRect) || goal6.collisionRect.Equals(dest3.collisionRect) || goal6.collisionRect.Equals(dest4.collisionRect) || goal6.collisionRect.Equals(dest5.collisionRect) || goal6.collisionRect.Equals(dest6.collisionRect) || goal6.collisionRect.Equals(dest7.collisionRect) || goal6.collisionRect.Equals(dest8.collisionRect))
            {
            ...
            if (goal7.collisionRect.Equals(dest1.collisionRect) || goal7.collisionRect.Equals(dest2.collisionRect) || goal7.collisionRect.Equals(dest3.collisionRect) || goal7.collisionRect.Equals(dest4.collisionRect) || goal7.collisionRect.Equals(dest5.collisionRect) || goal7.collisionRect.Equals(dest6.collisionRect) || goal7.collisionRect.Equals(dest7.collisionRect) || goal7.collisionRect.Equals(dest8.collisionRect))
            {
                spriteBatch.Draw(final5, goal7.collisionRect, Color.Red);

                g = true;

            }
            if (goal8.collisionRect.Equals(dest1.collisionRect) || goal8.collisionRect.Equals(dest2.collisionRect) || goal8.collisionRect.Equals(dest3.collisionRect) || goal8.collisionRect.Equals(dest4.collisionRect) || goal8.collisionRect.Equals(dest5.collisionRect) || goal8.collisionRect.Equals(dest6.collisionRect) || goal8.collisionRect.Equals(dest7.collisionRect) || goal8.collisionRect.Equals(dest8.collisionRect))
            {
                spriteBatch.Draw(final5, goal8.collisionRect, Color.Red);
