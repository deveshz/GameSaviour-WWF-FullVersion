...
namespace Zephyr
{
    ...
    /// </summary>
    public class SpriteManager4 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public SpriteManager4(Game game)
            : base(game)
        {
...
Vector2(450, 300), 0, new Point(50, 50), new Point(0, 0), new Point(4, 4), 0);
            //-----------------------ROW  1 -----------------------------------------------
...
0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
    Game.Content.Load<Texture2D>(@"Images/brick"),
    new Vector2(450, 350), 0, new Point(50, 50), new Point(0,
0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
 ...
 0), new Point(1, 1)));
            //-----------------------------------------------------
            goal1 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg3"),
...
Point(0, 0), new Point(1, 1));
 ...
 0), new Point(1, 1));
            goal3 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg3"),
             new Vector2(500, 450), 0, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            goal4 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/mdg3"),
...
0), new Point(1, 1));
            ...
            //-----------------------------------------------------------
            dest1 = new GoalBrick(
         Game.Content.Load<Texture2D>(@"Images/violencewomen"),
         new Vector2(450, 450), 50, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            dest2 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/violencewomen"),
            new Vector2(450,500), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest3 = new GoalBrick(
                Game.Content.Load<Texture2D>(@"Images/violencewomen"),
                new Vector2(500, 500), 50, new Point(50, 50), new
  Point(0, 0), new Point(1, 1));
            dest4 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/violencewomen"),
            new Vector2(550, 500), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest5 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/violencewomen"),
           new Vector2(600,500), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            //--------------------------------------------------
            final1 = Game.Content.Load<Texture2D>(@"Images/mdg3");
            final2 = Game.Content.Load<Texture2D>(@"Images/mdg3");
            final3 = Game.Content.Load<Texture2D>(@"Images/mdg3");
            final4 = Game.Content.Load<Texture2D>(@"Images/mdg3");
            final5 = Game.Content.Load<Texture2D>(@"Images/mdg3");
            ...
            background = Game.Content.Load<Texture2D>(@"Images\bg14");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (((Game1)Game).chances2 > 0)
                loose = false;
            else if (((Game1)Game).chances2 <= 0 && steps == -1)
                loose = true;
