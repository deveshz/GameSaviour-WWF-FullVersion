...
namespace Zephyr
{
    ...
    /// </summary>
    public class SpriteManager8 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public SpriteManager8(Game game)
            : base(game)
        {
...
Vector2(550, 450), 0, new Point(50, 50), new Point(0, 0), new Point(4, 4), 0);
            //-----------------------ROW  1 -----------------------------------------------
...
0), new Point(1, 1)));
            ...
            //-----------------------------------------------------
            goal1 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg6"),
             new Vector2(450, 350), 0, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            goal2 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/mdg6"),
            new Vector2(450, 400), 0, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            goal3 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg6"),
             new Vector2(650, 350), 0, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            goal4 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/mdg6"),
...
0), new Point(1, 1));
            //-----------------------------------------------------------
            dest1 = new GoalBrick(
         Game.Content.Load<Texture2D>(@"Images/epidemic"),
         new Vector2(400, 250), 50, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            dest2 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/epidemic"),
...
0), new Point(1, 1));
            //--------------------------------------------------
            final1 = Game.Content.Load<Texture2D>(@"Images/mdg6");
            final2 = Game.Content.Load<Texture2D>(@"Images/mdg6");
            final3 = Game.Content.Load<Texture2D>(@"Images/mdg6");
            final4 = Game.Content.Load<Texture2D>(@"Images/mdg6");
            final5 = Game.Content.Load<Texture2D>(@"Images/mdg6");
            final6 = Game.Content.Load<Texture2D>(@"Images/mdg6");
            ...
            background = Game.Content.Load<Texture2D>(@"Images\bg10");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (((Game1)Game).chances5 > 0)
                loose = false;
            else if (((Game1)Game).chances5 <= 0 && steps == -1)
                loose = true;
