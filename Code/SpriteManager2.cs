...
namespace Zephyr
{
    ...
    /// </summary>
    public class SpriteManager2 : Microsoft.Xna.Framework.DrawableGameComponent
    {
      ...
      public bool level3 = false;
        ...
        public SpriteManager2(Game game)
            : base(game)
        {
...
Vector2(550, 300), 0, new Point(50, 50), new Point(0, 0), new Point(4, 4), 0);
            //-----------------------ROW  1 -----------------------------------------------
...
0), new Point(1, 1)));
 ...
 0), new Point(1, 1)));
            spriteList.Add(new FixedBrick(
            Game.Content.Load<Texture2D>(@"Images/brick"),
            new Vector2(550, 350), 0, new Point(50, 50), new Point(0,
 0), new Point(1, 1)));
            //--------------------GOAL BRICK---------------------------------
            goal1 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg2"),
             new Vector2(500, 350), 0, new Point(50, 50), new
...
0), new Point(1, 1));
            //--------------------DESTINATION BRICK---------------------------------------
            dest1 = new GoalBrick(
         Game.Content.Load<Texture2D>(@"Images/ignorance"),
         new Vector2(450, 300), 50, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            dest2 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/ignorance"),
            new Vector2(450,400), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest3 = new GoalBrick(
                Game.Content.Load<Texture2D>(@"Images/ignorance"),
                new Vector2(650, 300), 50, new Point(50, 50), new
  Point(0, 0), new Point(1, 1));
            dest4 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/ignorance"),
            new Vector2(650,400), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest5 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/superstition"),
...
0), new Point(1, 1));
            //--------------------------------------------------
            final1 = Game.Content.Load<Texture2D>(@"Images/mdg2");
            final2 = Game.Content.Load<Texture2D>(@"Images/mdg2");
            final3 = Game.Content.Load<Texture2D>(@"Images/mdg2");
            final4 = Game.Content.Load<Texture2D>(@"Images/mdg2");
            final5 = Game.Content.Load<Texture2D>(@"Images/mdg2");
            final6 = Game.Content.Load<Texture2D>(@"Images/mdg2");
            ...
            background = Game.Content.Load<Texture2D>(@"Images\bg3");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (((Game1)Game).chances1 > 0)
                loose = false;
            else if (((Game1)Game).chances1 <= 0 && steps == -1)
                loose = true;
            ...
            if (goal6.collisionRect.Intersects(saviour.collisionRect) && (saviour.currentFrame.X == 2) && (keyboardState.IsKeyDown(Keys.Down)))
            {
                ...
                if (saviour.position.Y >= 500)
                    saviour.position.Y = 500;
                if (goal6.position.Y >= 550)
                    goal6.position.Y = 550;
