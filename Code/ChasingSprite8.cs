...
namespace Zephyr
{
    class ChasingSprite8 : Sprite
    {
        TrackManager8 trackManager8;

        public ChasingSprite8(Texture2D textureImage, Vector2 position,
...
TrackManager8 trackManager8)
        ...
        {
            this.trackManager8 = trackManager8;
        }
      ...
      TrackManager8 trackManager8)
        ...
        public override void Update(GameTime gameTime, Rectangle clientBounds)
        {
            ...
            Vector2 player = trackManager8.GetPlayerPosition();
