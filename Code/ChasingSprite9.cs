...
namespace Zephyr
{
    class ChasingSprite9 : Sprite
    {
        TrackManager9 trackManager9;

        public ChasingSprite9(Texture2D textureImage, Vector2 position,
...
TrackManager9 trackManager9)
        ...
        {
            this.trackManager9 = trackManager9;
        }
      ...
      TrackManager9 trackManager9)
        ...
        public override void Update(GameTime gameTime, Rectangle clientBounds)
        {
            ...
            Vector2 player = trackManager9.GetPlayerPosition();
