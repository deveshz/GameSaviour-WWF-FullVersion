...
namespace Zephyr
{
    ...
    /// </summary>
    public class SpriteManager3 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public SpriteManager3(Game game)
            : base(game)
        {
...
Vector2(700, 500), 0, new Point(50, 50), new Point(0, 0), new Point(4, 4), 0);
            //-----------------------ROW  1 -----------------------------------------------
...
Point(0, 0), new Point(1, 1));
 ...
 0), new Point(1, 1));
            goal3 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg3"),
             new Vector2(550, 250), 0, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            goal4 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/mdg3"),
...
0), new Point(1, 1));
            //--------------------DESTINATION BRICK---------------------------------------
            dest1 = new GoalBrick(
         Game.Content.Load<Texture2D>(@"Images/maledominance"),
...
Point(0, 0), new Point(1, 1));
 ...
 0), new Point(1, 1));
            dest5 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/maledominance"),
           new Vector2(500,350), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest6 = new GoalBrick(
          Game.Content.Load<Texture2D>(@"Images/maledominance"),
...
0), new Point(1, 1));
            ...
            final6 = Game.Content.Load<Texture2D>(@"Images/mdg3");
            ...
            background = Game.Content.Load<Texture2D>(@"Images\bg4");
