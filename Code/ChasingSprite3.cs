...
namespace Zephyr
{
    class ChasingSprite3 : Sprite
    {
        TrackManager3 trackManager3;

        public ChasingSprite3(Texture2D textureImage, Vector2 position,
...
TrackManager3 trackManager3)
        ...
        {
            this.trackManager3 = trackManager3;
        }
      ...
      TrackManager3 trackManager3)
        ...
        public override void Update(GameTime gameTime, Rectangle clientBounds)
        {
            ...
            Vector2 player = trackManager3.GetPlayerPosition();
