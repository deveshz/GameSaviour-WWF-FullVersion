...
namespace Zephyr
{
    ...
    /// </summary>
    public class TrackManager5 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        Vector2 hel_pos = new Vector2(20, 300);
        Vector2 hel_speed = new Vector2(30, 0);
        ...
        Vector2 carPosition = new Vector2(250, 300);
        ...
        bool moveup = false;
        bool movedown = false;
        public TrackManager5(Game game)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            track = Game.Content.Load<Texture2D>(@"Images/V");
       ...
       carHeight + 100, true, SurfaceFormat.Color, DepthFormat.Depth24Stencil8);
            ...
            mdg1 = Game.Content.Load<Texture2D>(@"Images/mdg4");
            mdg11 = Game.Content.Load<Texture2D>(@"Images/mdg4");

            mdg12 = Game.Content.Load<Texture2D>(@"Images/mdg4");

            mdg13 = Game.Content.Load<Texture2D>(@"Images/mdg4");

            mdg14 = Game.Content.Load<Texture2D>(@"Images/mdg4");
            mdg15 = Game.Content.Load<Texture2D>(@"Images/mdg4");
            mdg8 = Game.Content.Load<Texture2D>(@"Images/mdg8");
            mdg81 = Game.Content.Load<Texture2D>(@"Images/mdg8");
            helicopter = Game.Content.Load<Texture2D>(@"Images/helicopter");
            audioEngine = new AudioEngine(@"Content\Audio\GameAudio.xgs");
            waveBank = new WaveBank(audioEngine, @"Content\Audio\Wave Bank.xwb");
            soundBank = new SoundBank(audioEngine, @"Content\Audio\Sound Bank.xsb");


            mdg1rep = Game.Content.Load<Texture2D>(@"Images/mdg4rep");
            
            
            trackoverlay = Game.Content.Load<Texture2D>(@"Images/overlayV");
            text = Game.Content.Load<SpriteFont>(@"Fonts\Snap");
            report = Game.Content.Load<Texture2D>(@"Images/reportf");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (power)
                ...
                mdg1Rect = new Rectangle(300, 450, 50, 50);
            if (power1)
                mdg11Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg11Rect = new Rectangle(330, 300, 50, 50);
            if (power2)
                mdg12Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg12Rect = new Rectangle(500, 430, 50, 50);
            if (power3)
                mdg13Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg13Rect = new Rectangle(520, 380, 50, 50);
            if (power4)
                mdg14Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg14Rect = new Rectangle(500, 50, 50, 50);
            if (power5)
                mdg15Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg15Rect = new Rectangle(280, 300, 50, 50);
            if (power6)
                mdg8Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg8Rect = new Rectangle(520, 100, 50, 50);
            if (power7)
                mdg81Rect = new Rectangle(2000, 2000, 50, 50);
            else
                mdg81Rect = new Rectangle(340, 500, 50, 50);
            if (mdg8_rep >= 1 && aKeyboard.IsKeyDown(Keys.Enter) == true)
                isOver = true;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.Draw(mdg8, new Vector2(520, 100), Color.White);
                b = true;
            }
            else
                power6 = false;
            ...
            {
                spriteBatch.Draw(mdg81, new Vector2(340, 500), Color.White);
                c = true;
            }
            else
                power7 = false;
            ...
            if (power)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(300, 450, 50, 50), Color.White);
            ...
            if (power3)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(520, 380, 50, 50), Color.White);

            }
            if (power4)
            {

                spriteBatch.Draw(mdg1rep, new Rectangle(500, 50, 50, 50), Color.White);
            ...
            if (power6)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(520, 100, 50, 50), Color.White);


            }
            if (power7)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(340, 500, 50, 50), Color.White);
...
1, SpriteEffects.None, 1);
            ...
            spriteBatch.Draw(helicopter, hel_pos, Color.White);
        ...
        private void SpawnEnemy()
        {
            ...
            // Create the sprite
            spriteList.Add(
                  new ChasingSprite5(Game.Content.Load<Texture2D>(@"Images\sorrow"),
                  position + new Vector2(-120, 80), new Point(60, 60), 10, new Point(0, 0),
                  new Point(1, 1), speed, this));
               spriteList2.Add(
              new ChasingSprite5(Game.Content.Load<Texture2D>(@"Images\darkfuture"),
