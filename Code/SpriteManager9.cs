...
namespace Zephyr
{
    ...
    /// </summary>
    public class SpriteManager9 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public SpriteManager9(Game game)
            : base(game)
        {
...
Vector2(550, 350), 0, new Point(50, 50), new Point(0, 0), new Point(4, 4), 0);
            //-----------------------ROW  1 -----------------------------------------------
...
Point(0, 0), new Point(1, 1));
 ...
 0), new Point(1, 1));
            goal3 = new GoalBrick(
             Game.Content.Load<Texture2D>(@"Images/mdg7"),
             new Vector2(600, 300), 0, new Point(50, 50), new
Point(0, 0), new Point(1, 1));
            goal4 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/mdg7"),
...
0), new Point(1, 1));
            //-----------------------------------------------------------
            dest1 = new GoalBrick(
         Game.Content.Load<Texture2D>(@"Images/pollution"),
...
Point(0, 0), new Point(1, 1));
 ...
 0), new Point(1, 1));
            dest3 = new GoalBrick(
                Game.Content.Load<Texture2D>(@"Images/pollution"),
                new Vector2(650, 250), 50, new Point(50, 50), new
  Point(0, 0), new Point(1, 1));
            dest4 = new GoalBrick(
            Game.Content.Load<Texture2D>(@"Images/pollution"),
            new Vector2(450,350), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest5 = new GoalBrick(
           Game.Content.Load<Texture2D>(@"Images/pollution"),
           new Vector2(450,450), 50, new Point(50, 50), new Point(0,
 0), new Point(1, 1));
            dest6 = new GoalBrick(
          Game.Content.Load<Texture2D>(@"Images/pollution"),
          new Vector2(550,450), 50, new Point(50, 50), new Point(0,
0), new Point(1, 1));
            dest7 = new GoalBrick(
          Game.Content.Load<Texture2D>(@"Images/pollution"),
...
0), new Point(1, 1));
            dest8 = new GoalBrick(
          Game.Content.Load<Texture2D>(@"Images/pollution"),
          new Vector2(650, 450), 50, new Point(50, 50), new Point(0,
0), new Point(1, 1));
            //--------------------------------------------------
            ...
            background = Game.Content.Load<Texture2D>(@"Images\bg9");
