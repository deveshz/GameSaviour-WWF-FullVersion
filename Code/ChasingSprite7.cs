...
namespace Zephyr
{
    class ChasingSprite7 : Sprite
    {
        TrackManager7 trackManager7;

        public ChasingSprite7(Texture2D textureImage, Vector2 position,
...
TrackManager7 trackManager7)
        ...
        {
            this.trackManager7 = trackManager7;
        }
      ...
      TrackManager7 trackManager7)
        ...
        public override void Update(GameTime gameTime, Rectangle clientBounds)
        {
            ...
            Vector2 player = trackManager7.GetPlayerPosition();
