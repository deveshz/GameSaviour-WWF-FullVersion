...
namespace Zephyr
{
    ...
    /// </summary>
    public class TrackManager3 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        Vector2 carPosition = new Vector2(220, 45);
        ...
        bool moveup = false;
        bool movedown = false;
        public TrackManager3(Game game)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            track = Game.Content.Load<Texture2D>(@"Images/R");
       ...
       carHeight + 100, true, SurfaceFormat.Color, DepthFormat.Depth24Stencil8);
            ...
            mdg1 = Game.Content.Load<Texture2D>(@"Images/mdg3");
            mdg11 = Game.Content.Load<Texture2D>(@"Images/mdg3");

            mdg12 = Game.Content.Load<Texture2D>(@"Images/mdg3");

            mdg13 = Game.Content.Load<Texture2D>(@"Images/mdg3");

            mdg14 = Game.Content.Load<Texture2D>(@"Images/mdg3");
            mdg15 = Game.Content.Load<Texture2D>(@"Images/mdg3");
            ...
            mdg1rep = Game.Content.Load<Texture2D>(@"Images/mdg3rep");
            obstacle = Game.Content.Load<Texture2D>(@"Images/obstacle");
            obstaclerep = Game.Content.Load<Texture2D>(@"Images/obstaclerep");
            trackoverlay = Game.Content.Load<Texture2D>(@"Images/overlayR");
            text = Game.Content.Load<SpriteFont>(@"Fonts\Snap");
            report = Game.Content.Load<Texture2D>(@"Images/reportd");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.Draw(mdg8, new Vector2(330, 257), Color.White);
                b = true;
            }
            else
                power6 = false;
            ...
            {
                spriteBatch.Draw(mdg81, new Vector2(630, 332), Color.White);
                c = true;
            }
            else
                power7 = false;
            ...
            if (power)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(230, 256, 50, 50), Color.White);
            ...
            if (power1)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(532, 152, 50, 50), Color.White);
            ...
            if (power3)
            {
                ...
                spriteBatch.Draw(mdg1rep, new Rectangle(352, 44, 50, 50), Color.White);

            }
            if (power4)
            {

                spriteBatch.Draw(mdg1rep, new Rectangle(550,430, 50, 50), Color.White);
            ...
            if (power6)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(330,257, 50, 50), Color.White);


            }
            if (power7)
            {
                spriteBatch.Draw(mdg1rep, new Rectangle(630, 332, 50, 50), Color.White);
...
1, SpriteEffects.None, 1);
        ...
        private void SpawnEnemy()
        {
            ...
            // Create the sprite
          spriteList.Add(
               new ChasingSprite3(Game.Content.Load<Texture2D>(@"Images\violencewomen"),
               position + new Vector2(-120, 80), new Point(60, 60), 10, new Point(0, 0),
               new Point(1, 1), speed, this));
            spriteList2.Add(
           new ChasingSprite3(Game.Content.Load<Texture2D>(@"Images\maledominance"),
           position + new Vector2(20, 20), new Point(60, 60), 10, new Point(0, 0),
           new Point(1, 1), speed, this));
            spriteList3.Add(
  new AutomatedSprite(Game.Content.Load<Texture2D>(@"Images\girlpower"),
